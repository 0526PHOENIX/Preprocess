...
class Preprocess():
    ...
    def transform(self) -> None:
        ...
        print()
        print('=======================================================================================================')
        print('Interpolate to (192, 192, 192) + Rotate')
        print('=======================================================================================================')
        print()
    ...
    def intensity(self) -> None:
        ...
        """
        ================================================================================================================
        Clip CT Intensity + Find Appropriate MR Maximum Value
        ================================================================================================================
        """
        # List of Maximum Value of MR
        maximum = []
        ...
        # Clip Intensity
        image = np.clip(image, 0, maximum.mean())
        ...
        # Check Process
        print('-------------------------------------------------------------------------------------------------------')
        print('Clip MR11, MR14, MR26 Intensity')
        print('-------------------------------------------------------------------------------------------------------')
        print()
    ...
    def statistic(self) -> None:
        ...
        print('-------------------------------------------------------------------------------------------------------')
        print("{:15}{:15}{:15}{:15}{:15}{:15}{:15}".format('File Name', 'Mean', 'STD', 'Min', 'Max', 'Skewness', 'Kurtosis'))
        print('-------------------------------------------------------------------------------------------------------')
        ...
        for i in range(self.len):
            ...
            # Check Statistics
            space = "{:15}{: <15.2f}{: <15.2f}{: <15.2f}{: <15.2f}{: <15.2f}{: <15.2f}"
            print(space.format(self.images[i], image.mean(), image.std(), image.min(), image.max(), stats.skew(image), stats.kurtosis(image)))
            print(space.format(self.labels[i], label.mean(), label.std(), label.min(), label.max(), stats.skew(label), stats.kurtosis(label)))
            print()
        
        # Check Mean and STD Behavior
        print('-------------------------------------------------------------------------------------------------------')
        print("{:15}{:15}{:15}{:15}{:15}".format('', 'Mean Mean', 'Mean STD', 'STD Mean', 'STD STD'))
        print('-------------------------------------------------------------------------------------------------------')
